  ...
  router.post("/companies/:companyId/agent-hires", validate(createAgentHireSchema), async (req, res) => {
    ...
    const createdAgent = await svc.create(
      ...
      },
      {
        ...
        ...(normalizedHireInput.adapterType === "openclaw_gateway" ? { actor: { userId: req.actor.userId, agentId: req.actor.agentId } } : {}),
      },
    );
  ...
  router.post("/companies/:companyId/agents", validate(createAgentSchema), async (req, res) => {
    ...
    const createdAgent = await svc.create(
      ...
      },
      {
        ...
        ...(createInput.adapterType === "openclaw_gateway" ? { actor: { userId: req.actor.userId, agentId: req.actor.agentId } } : {}),
      },
    );
    const agent = await materializeDefaultInstructionsBundleForNewAgent(createdAgent, instructionsBundle);
