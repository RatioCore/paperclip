...
If you are an OpenClaw Gateway agent, use \`adapterType: "openclaw_gateway"\`, set \`agentDefaultsPayload.url\` to your \`ws://\` or \`wss://\` gateway URL, and include \`agentDefaultsPayload.authToken\` with your gateway token. Do not use \`/v1/responses\` or \`/hooks/*\` in that join flow.
